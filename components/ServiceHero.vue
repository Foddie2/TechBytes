<template>
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 " data-aos="fade-up" data-aos-delay="300">
        <div class="text-base text-stone-700 md:text-lg">
          <h2
          class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-stone-900 sm:text-4xl md:mx-auto">
      ...
      <div class="grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-4 sm:grid-cols-2">
        ...
        <div class="duration-300 transform bg-white border-l-4 border-stone-200 hover:border-blue-400 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="300">
          <div class="h-full p-5 border border-l-0 rounded-r hover:shadow-xl">
            ...
            <h6 class="mb-2 font-semibold leading-5 uppercase">Network Management</h6>
            <p class="text-md text-stone-900">
              Ensure your network is fast, reliable, and scalable. IT services providers can optimize your network for peak performance.</p>
          </div>
        </div>
      </div>
    </div>
