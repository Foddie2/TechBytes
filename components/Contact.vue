	...
	<div class="container mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-20 mb-12">
		...
		<div class="w-full p-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
            ...
            type="number" placeholder="Phone*" />
				...
				<div class="my-4">
					<textarea placeholder="Message*" class="w-full h-32 bg-green-50 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
				</div>
				<div class="my-2 w-1/2 lg:w-1/4">
					<button class="uppercase text-sm font-bold tracking-wide bg-green-500 text-gray-100 p-3 rounded-lg w-full 
            ...
            <div class="flex flex-col">
              ...
              <p class="text-gray-100">5555 Tailwind RD, Pleasant Grove, UT 73533</p>
            </div>
          </div>
          ...
          <div class="flex my-4 w-2/3 lg:w-1/2">
            ...
            <div class="flex flex-col">
              ...
              <p class="text-gray-100">Tel: xxx-xxx-xxx</p>
              <p class="text-gray-100">Fax: xxx-xxx-xxx</p>
            </div>
          </div>
        </div>
      </div>
