<template>
<!-- component -->
<div class=" max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 mx-auto">
    <main class="mt-10">
      <div class="block md:flex md:space-x-2 px-2 lg:p-0">
        ...
        >
          ...
          <img src="https://images.pexels.com/photos/1291712/pexels-photo-1291712.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" />
          <div class="p-4 absolute bottom-0 left-0">
            <span class="px-4 py-1 bg-pink-900 text-white inline-flex items-center justify-center mb-2">Nutrition</span>
      ...
      <div class="block lg:flex lg:space-x-2 px-2 lg:p-0 mt-10 mb-10">
        ...
        <div class="w-full lg:w-2/3">
          ...
          >
            <div 
              ...
              style="background-image: url('https://images.pexels.com/photos/913134/pexels-photo-913134.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')" 
          ...
          <div class="rounded w-full lg:flex mb-10">
            <div class="h-48 lg:w-48 flex-none bg-cover text-center overflow-hidden opacity-75"
              style="background-image: url('https://images.pexels.com/photos/853005/pexels-photo-853005.jpeg?auto=compress&cs=tinysrgb&w=600')" title="deit is very important">
            </div>
            <div class="bg-white rounded px-4 flex flex-col justify-between leading-normal">
              <div>
                <div class="mt-3 md:mt-0 text-gray-700 font-bold text-2xl mb-2">
          ...
          <div class="rounded w-full lg:flex mb-10">
            <div class="h-48 lg:w-48 flex-none bg-cover text-center overflow-hidden opacity-75"
              style="background-image: url('https://images.pexels.com/photos/10281284/pexels-photo-10281284.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')" title="deit is very important">
            </div>
            <div class="bg-white rounded px-4 flex flex-col justify-between leading-normal">
              <div>
                <div class="mt-3 md:mt-0 text-gray-700 font-bold text-2xl mb-2">
        ...
        <div class="w-full lg:w-1/3 px-3">
          <!-- topics -->
          <div class="mb-4">
            <h5 class="font-bold text-lg uppercase text-gray-700 px-1 mb-2"> Popular Flavours </h5>
            <ul>
              <li class="px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300">
                <a href="#" class="flex items-center text-gray-700 cursor-pointer">
                  <span class="inline-block h-4 w-4 bg-pink-300 mr-3"></span>
                  Bubblegum Cakes
                  <span class="text-gray-500 ml-auto">+ 150 Orders</span>
                  <i class='text-gray-500 bx bx-right-arrow-alt ml-1'></i>
                </a>
              </li>
              <li class="px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300">
                <a href="#" class="flex items-center text-gray-700 cursor-pointer">
                  <span class="inline-block h-4 w-4 bg-pink-500 mr-3"></span>
                  Strawberry Cakes
                  <span class="text-gray-500 ml-auto">+ 250 Orders</span>
                  <i class='text-gray-500 bx bx-right-arrow-alt ml-1'></i>
                </a>
              </li>
              <li class="px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300">
                <a href="#" class="flex items-center text-gray-600 cursor-pointer">
                  <span class="inline-block h-4 w-4 bg-pink-700 mr-3"></span>
                  Vanilla Cakes
                  <span class="text-gray-500 ml-auto">+ 300 Orders</span>
                  <i class='text-gray-500 bx bx-right-arrow-alt ml-1'></i>
                </a>
              </li>
              <li class="px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300">
                <a href="#" class="flex items-center text-gray-600 cursor-pointer">
                  <span class="inline-block h-4 w-4 bg-pink-200 mr-3"></span>
                  Blackforest Cakes
                  <span class="text-gray-500 ml-auto">+ 100 Orders</span>
                  <i class='text-gray-500 bx bx-right-arrow-alt ml-1'></i>
                </a>
              </li>
            </ul>
          ...
          <div class="p-1 mt-4 mb-4">
            ...
            <input placeholder="your email address"
              class="text-gray-700 bg-pink-50 rounded-t hover:outline-none p-2 w-full mt-4 border" />
            <button class="px-4 py-2 bg-pink-700 text-white rounded-b w-full capitalize tracking-wide">
              Subscribe
            </button>
          </div>
