    ...
    <div class="bg-stone-900 text-white py-8">
      ...
      >
        <div class="flex flex-col w-full lg:w-1/3 justify-center items-start p-4">
          ...
          <a href="#_" class="relative inline-flex items-center px-12 py-3 my-5 overflow-hidden text-lg font-medium text-green-400 border-2 border-green-400 rounded-full hover:text-black group hover:bg-green-400">
