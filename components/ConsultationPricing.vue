    ...
    <div class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-8 mx-auto max-w-screen-xl first-letter:pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24 lg:pb-24">
            <div class="flex flex-col items-center justify-center xl:items-start xl:mx-8 mb-8">
             ...
             <!--    <a href="#" class="flex items-center mt-4 -mx-1 text-sm text-gray-700 capitalize dark:text-blue-600 hover:underline hover:text-blue-600 dark:hover:text-blue-600">
            ...
            <div class="flex flex-col items-center justify-center space-y-8 lg:-mx-4 lg:flex-row lg:items-stretch lg:space-y-0">
                <div class="flex flex-col w-full max-w-sm p-8 space-y-8 text-center bg-white border-2 border-blue-200 rounded-lg lg:mx-4 hover:bg-blue dark:bg-gray-900 dark:border-gray-700">
                ...
                <div class="flex flex-col w-full max-w-sm p-8 space-y-8 text-center bg-white border-2 border-blue-200 rounded-lg lg:mx-4 dark:bg-gray-900 dark:border-gray-700">
                    <div class="flex-shrink-0">
                        <h2 class="inline-flex items-center justify-center px-2 font-semibold tracking-tight text-blue-600 uppercase rounded-lg bg-gray-50 dark:bg-gray-700">
                            Professional
                        </h2>
